-- S-PROG-13 (expand, endurecimento): a tabela temporária da função de salvar rascunho por
-- categoria passa a ser sempre recriada (DROP antes do CREATE), em vez de reaproveitada se já
-- existir na sessão. Mesma assinatura e mesmo comportamento.
